...
class HBNBCommand(cmd.Cmd):
    ...
    def do_all(self, line):
        """Print all string representations of all instances based on or
    ...
    def __check_update_args(line):
        """Validates arguments given to update command.

        Args:
            line (str): Space separated string of arguments.

        Returns:
            tuple: Tuple of a key, attribute name and attribute value.
    ...
    def do_update(self, line):
        """Updates instance based on class name and id by adding or
        updating attribute.
    ...
    def do_count(self, line):
        """Count the number of instaces of a class
    ...
    def parse_default_args(line):
        ...
        Args:
            line (str): String containing arguments and commands.

        Returns:
            tuple: Tuple of arguments parsed from the string given.
                The tuple consist of:
    ...
    def do_EOF(self, line):
        """Exits program when EOF is encountered"""
        return True
